...
def main():
    ...
    def buildOptions():
        #placholder
     mainMenu.addOption("How many days would it take to climb a mountain?")
     mainMenu.addOption("What year was the computer first made?")
     mainMenu.addOption("Who is the first Pokemon in the pokedex?")
     buildOptions()
